...
<body>
    ...
    <div class="side-nav">
        <div class="list-group ">
            ...
            <a class="sideb list-group-item list-group-item-action waves-effect" href="/myoffers" method="GET" class="sideb list-group-item list-group-item list-group-item-action waves-effect ">
    ...
    <div class="container " style="align-items: center ">
        ...
        <div class="content " style="align-self: center ">
            <div class="data " style="align-items: center ">
                ...
                <div class="edit ">
                    <a href="/src/view/editProfile.html"> Edit Profile</a>
                </div>
